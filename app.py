...
def load_txt_to_csv():
    ...
    TXT_FILE_PATH = "data/cities15000.txt"
    CSV_FILE_PATH = "data/cities5000.csv"
    LOG_FILE_PATH = "data/csv_conversion.log"
    ...
    try:
        ...
        # Create CSV file with explicit directory checking
